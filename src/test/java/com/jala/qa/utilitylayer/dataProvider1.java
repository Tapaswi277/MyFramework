...
public class dataProvider1 {
	 ...
	 public Object[][] fetchDataFromExcel() throws IOException {
			FileInputStream path=new FileInputStream("C:\\Users\\DELL\\Desktop\\eclipse workspace\\Hybrid_Framework\\src\\main\\java\\com\\jala\\qa\\datalayer\\Book.xlsx");
			XSSFWorkbook action=new XSSFWorkbook(path);
			XSSFSheet sheetNumber=action.getSheet("Sheet2");
